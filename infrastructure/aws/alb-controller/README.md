...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aws-load-balancer-controller-role"></a> [aws-load-balancer-controller-role](#module\_aws-load-balancer-controller-role) | terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts | n/a |
